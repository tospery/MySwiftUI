...
public struct Metric {
    ...
    public struct Tile {
        public static let spaceHeight       = 20.0
        public static let buttonHeight      = 44.0
        public static let cellHeight        = 50.0
        public static let titleFontSize     = 16.0
        public static let detailFontSize    = 14.0
